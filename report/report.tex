...
\begin{document}
    ...
    \input{sections/3_conceptual_design}

    \chapter{Progettazione logica}
    \input{sections/4_schema_restructuring}

    \input{sections/5_logical_design}

    \chapter{Progettazione fisica}
    \input{sections/6_physical_design}

    \chapter{Operazioni e interrogazioni}
    \input{sections/7_queries}
    ...
    \appendix
    \chapter{Glossario}
    \input{sections/a1_glossary}

    \chapter{Tracciabilità dei requisiti}
    \input{sections/a2_requirements_traceability}
