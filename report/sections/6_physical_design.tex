...
Al contrario, la funzione \texttt{aggiorna\_crediti\_post\_delete()} agisce in modalità \texttt{AFTER DELETE} aggiornando il saldo solo se l'entità padre è ancora presente nel sistema, garantendo così una perfetta convivenza tra i vincoli dichiarativi e quelli procedurali.

L'implementazione fisica della procedura è stata strutturata come segue:
