...
Qualsiasi tentativo di eseguire operazioni di \texttt{UPDATE} sulla tabella \texttt{esame} viene intercettato in modalità \texttt{BEFORE}, sollevando un'eccezione irreversibile che congela lo stato della carriera studentesca.
