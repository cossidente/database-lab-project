...
Il vincolo secondo cui un docente può tenere solo gli insegnamenti per cui è abilitato viene fatto rispettare in fase di inserimento nella tabella \texttt{insegnamento_edizione}. La funzione \texttt{controlla\_abilitazione\_docente} interroga preventivamente la tabella ponte delle competenze stabili, bloccando l'assegnazione della cattedra qualora non vi sia una corrispondenza esatta tra il codice fiscale del docente e l'insegnamento erogato.
