...
Per garantire che l'operazione di \texttt{UPDATE} non assegni cattedre in modo illegittimo o a docenti non qualificati, è stata inserita una rigorosa condizione di validazione tramite la sottoquery \texttt{EXISTS}.
