...
\begin{longtable}{ >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{7.5cm} >{\raggedright\arraybackslash}p{3.5cm}}
    ...
    \textbf{Prerequisito} & Insegnamento che deve essere stato superato prima di poter sostenere l'esame di un altro insegnamento. & Insegnamento \\
    ...
    \textbf{Esame} & Storico delle prove per insegnamento, comprensivo di tutti gli esiti (positivi e negativi) e dei relativi punteggi. & Studente, Insegnamento \\
