...
\begin{longtable}{ >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{7.5cm} >{\raggedright\arraybackslash}p{3.5cm}}
    ...
    \textbf{Esame} & Tentativo sostenuto da uno studente per un determinato insegnamento, costituito da un'unica prova d'esame. Memorizza l'esito finale (positivo o negativo) e il punteggio ottenuto. & Studente, Insegnamento \\
