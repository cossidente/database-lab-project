...
\begin{longtable}{ >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{7.5cm} >{\raggedright\arraybackslash}p{3.5cm}}
    ...
    \textbf{Esame} & Tentativo sostenuto da uno studente per un determinato insegnamento, costituito da un'unica prova d'esame. Memorizza il punteggio ottenuto, inclusi i voti insufficienti. & Studente, Insegnamento \\
